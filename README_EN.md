...
<p align="center">
  <img src="assets/logo.png" alt="cc-portkey logo" width="400">
</p>
...
> **Why "Portkey"?**
>
> A Portkey is a magical object from *Harry Potter* — touch it and you're instantly transported somewhere else.
>
> This tool works the same way: one command, and Claude Code is teleported to a different model provider.
...
- Quick alias commands (`ccc`, `ds`, `glm`, `mm`) for instant switching
...
Download the latest binary from [Releases](https://github.com/NanmiCoder/cc-portkey/releases) and add it to your PATH.
